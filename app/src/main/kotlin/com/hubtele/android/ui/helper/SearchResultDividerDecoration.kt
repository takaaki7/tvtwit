...
class SearchResultDividerDecoration(val context: Context) : RecyclerView.ItemDecoration () {
    ...
    private fun drawVertical(c: Canvas, parent: RecyclerView) {
        ...
        for (i in 0..childCount - 2) {
            //top is searchbar and border is unneeded
            val child = parent.getChildAt(i);
            if (i == 0 && parent.getChildAdapterPosition(child) == 0) continue
